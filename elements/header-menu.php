...
<nav class="eg-nav" role="navigation" aria-label="Main navigation">
  <div class="eg-nav-inner">
    ...
    <!-- LOGO -->
    <a href="#" class="eg-logo" aria-label="The Euphoria Group home">
    ...
    <ul class="eg-menu" id="eg-desktop-menu">
      ...
      <li class="eg-active">
        ...
        <div class="eg-mega" role="menu">
          <div class="eg-mega-grid">
            ...
            <a href="#" class="eg-mega-item" role="menuitem">
      ...
      <li>
        ...
        <div class="eg-dropdown" role="menu">
          <a href="#" role="menuitem">Export Consultancy</a>
          <a href="#" role="menuitem">International Trade</a>
          <a href="#" role="menuitem">Global Market Entry</a>
          <a href="#" role="menuitem">Logistics &amp; Freight</a>
          <a href="#" role="menuitem">Cross-Border Compliance</a>
        </div>
      </li>
...
<div class="eg-mobile-menu" id="eg-mobile-menu" aria-hidden="true">
  ...
  <a href="#" class="eg-mob-link">Home</a>
  <a href="#" class="eg-mob-link">About Euphoria</a>
  ...
  <div class="eg-mob-sub" id="mob-outbound-sub">
    <a href="#" class="eg-mob-sub-item">Export Consultancy</a>
    <a href="#" class="eg-mob-sub-item">International Trade</a>
    <a href="#" class="eg-mob-sub-item">Global Market Entry</a>
    <a href="#" class="eg-mob-sub-item">Logistics &amp; Freight</a>
    <a href="#" class="eg-mob-sub-item">Cross-Border Compliance</a>
  </div>

  <a href="#" class="eg-mob-link">Partner Up</a>
  <a href="#" class="eg-mob-link">Career</a>
  <a href="#" class="eg-mob-link">Blog</a>
