...
<style>
  ...
  .re-service-cell:hover .re-service-cell-title {
    color: var(--euphoria-red);
  }
  ...
  /* ── RESPONSIVE ── */
  /* --- Holiday Package Grid Mobile Styles --- */

  @media (max-width: 1199px) {

    /* Shift from 5 columns to 3 columns for smaller desktops/tablets */
    .re-service-grid {
      grid-template-columns: repeat(3, 1fr);
    }

    /* Reset previous border logic and apply clean 3-col borders */
    .re-service-cell {
      border: 1px solid var(--card-border) !important;
      margin: -0.5px;
      /* Prevents double-border thickness */
    }
  }
  ...
  @media (max-width: 991px) {
    ...
    /* Scale background watermark */
    .re-serrvice-section .about-title-bg {
      font-size: 6rem !important;
      top: -30px !important;
    }
  ...
  @media (max-width: 767px) {
    ...
    /* Specific border cleanup for 2-column mobile layout */
    .re-service-cell {
      padding: 20px 15px;
    }
    ...
    /* Remove outer borders to keep it "airy" on mobile */
    .re-service-cell:nth-child(odd) {
      border-left: none !important;
    }

    .re-service-cell:nth-child(even) {
      border-right: none !important;
    }

    .re-service-cell:nth-child(-n+2) {
